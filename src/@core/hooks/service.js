...
const base_URL = `https://kabo.designparklab.com.ng/`;
...
export function getTeams(data){
    ...
    return instance.post('/store/teams', data);
}

export function getRider(data){
    return instance.post('rider/list', data);
}

export function addRider(data){
    return instance.post('rider/add', data);
}
...
export function active(data){
    ...
    return instance.post('store/update-account', data);
}
...
export function editRider(data){
    return instance.post('rider/update', data);
}
...
export function updateBank(data){
    return instance.post('store/update-bank-details', data);
...
export function earnings(data){
    return instance.post("order/earnings", data);
}
