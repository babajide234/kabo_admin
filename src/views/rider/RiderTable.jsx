...
const createData = (id, name, email,capped,rate,type ) => {
    return { id, name, email,capped,rate,type }
}
                                ...
                                {filteredData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => (
                                    ...
                                    >
                                        ...
                                        <TableCell align='right'>{
                                            <>
                                                <IconButton variant="outlined" style={{ marginRight: 10}} size="small" onClick={()=>handleEdit(row.id)}>
